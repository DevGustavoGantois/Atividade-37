...
if idade == 9:
    print('O Atleta tem {} anos, nasceu em {} e será da categoria MIRIM até 9 anos.'.format(idade, nascimento))
elif idade <= 14:
    print('O Atleta tem {} anos, nasceu em {} e será da categoria INFANTIL até 14 anos.'.format(idade, nascimento))
elif idade <= 19:
    print('O Atleta tem {} anos, nasceu em {} e será da categoria JÚNIOR até 19 anos.'.format(idade, nascimento))
elif idade <= 25:
    print('O Atleta tem {} anos, e nasceu em {} e será da categoria SÊNIOR até 25 anos'.format(idade, nascimento))
elif idade > 25:
