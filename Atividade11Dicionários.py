...
def receive_dictionary(key, value, dictionary):
    ...
    if key in dictionary:
        print(f"The key in dictionary {key} exists. Updating the value to {value}")
    else:
...
# Converte o valor para um tipo adequado (por exemplo, int)
try:
...
receive_dictionary(key_user, value_user, my_dictionary)
